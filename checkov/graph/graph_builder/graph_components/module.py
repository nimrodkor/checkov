...
from checkov.graph.graph_builder.graph_components.blocks import Block, get_inner_attributes
...
class Module:
    ...
    def _add_custom_block(self, blocks, path):
        for custom_block_name in blocks:
            custom_block = Block(
            ...
            self.blocks.append(custom_block)
    ...
    _block_type_to_func = {
        ...
        BlockType.CUSTOM: _add_custom_block
    }
