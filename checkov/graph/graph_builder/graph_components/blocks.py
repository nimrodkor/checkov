...
from checkov.graph.utils import utils
from checkov.graph.utils.utils import calculate_hash, decode_graph_property_value, join_trimmed_strings
...
class Block:
    ...
    def get_attribute_dict(self):
        """
           ...
           """
        base_attributes = {
            CustomAttributes.BLOCK_NAME.value: self.name,
            CustomAttributes.BLOCK_TYPE.value: self.block_type.value,
            CustomAttributes.FILE_PATH.value: self.path,
            CustomAttributes.CONFIG.value: self.config,
            CustomAttributes.LABEL.value: self.__str__(),
            CustomAttributes.ID.value: self.id,
            CustomAttributes.SOURCE.value: self.source
        }
        ...
        if self.breadcrumbs:
            ...
            base_attributes[CustomAttributes.RENDERING_BREADCRUMBS.value] = sorted_breadcrumbs
        ...
        base_attributes[CustomAttributes.HASH.value] = calculate_hash(base_attributes)
    ...
    def get_hash(self):
        ...
        return attributes_dict.get(CustomAttributes.HASH.value)
