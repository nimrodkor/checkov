...
def convert_graph_vertices_to_tf_definitions(vertices: List[Block], root_folder):
    ...
    for vertex in vertices:
        ...
        relative_block_path = f"/{os.path.relpath(block_path, root_folder)}" if not vertex.module_dependency else f"/{os.path.relpath(vertex.module_dependency, root_folder)}"
