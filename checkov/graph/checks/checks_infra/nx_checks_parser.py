...
from checkov.graph.checks.checks_infra.solvers.attribute_queries.any_attribute_solver import AnyResourceSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.array_contains_attribute_solver import ArrayContainsAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.array_not_contains_attribute_solver import ArrayNotContainsAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.ending_with_attribute_solver import \
    EndingWithAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.equals_attribute_solver import EqualsAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.exists_attribute_solver import ExistsAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.not_ending_with_attribute_solver import \
    NotEndingWithAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.not_equals_attribute_solver import NotEqualsAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.not_exists_attribute_solver import NotExistsAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.within_attribute_solver import WithinAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.starting_with_attribute_solver import StartingWithAttributeSolver
from checkov.graph.checks.checks_infra.solvers.attribute_queries.not_starting_with_attribute_solver import NotStartingWithAttributeSolver
from checkov.graph.checks.checks_infra.solvers.complex_queries.and_solver import AndSolver
from checkov.graph.checks.checks_infra.solvers.complex_queries.or_solver import OrSolver
from checkov.graph.checks.checks_infra.solvers.connections_queries.and_connection_solver import AndConnectionSolver
from checkov.graph.checks.checks_infra.solvers.connections_queries.connection_exists_solver import ConnectionExistsSolver
from checkov.graph.checks.checks_infra.solvers.connections_queries.connection_not_exists_solver import ConnectionNotExistsSolver
from checkov.graph.checks.checks_infra.solvers.connections_queries.or_connection_solver import OrConnectionSolver
from checkov.graph.checks.checks_infra.enums import SolverType
from checkov.graph.checks.checks_infra.solvers.filter_queries.within_filter_solver import WithinFilterSolver
...
class NXGraphCheckParser(BaseGraphCheckParser):
    ...
    def _parse_raw_check(self, raw_check, resources_types):
        ...
        if complex_operator:
            ...
            if resource_type == ['All'] or resource_type == 'all' or (not resource_type and is_custom_policy):
