...
from checkov.graph.utils.utils import replace_map_attribute_access_with_dot, get_referenced_vertices_in_value, \
    VertexReference, update_dictionary_attribute


class Test(TestCase):
    def test_find_non_literal_values(self):
        aliases = {'aws': {CustomAttributes.BLOCK_TYPE.value: BlockType.PROVIDER}}
        str_value = 'aws.east1'
